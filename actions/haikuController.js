...
async function sharedHaikuLogic(formData, user) {
  ...
  if (ourHaiku.line1 == 0) errors.line1 = "This field is required."
  if (ourHaiku.line2 == 0) errors.line2 = "This field is required."
  if (ourHaiku.line3 == 0) errors.line3 = "This field is required."
...
export const deleteHaiku = async function (formData) {
  ...
  // make sure you are the author, otherwise script will fail
